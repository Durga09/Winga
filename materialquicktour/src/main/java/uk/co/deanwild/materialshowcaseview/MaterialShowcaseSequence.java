...
public class MaterialShowcaseSequence implements IDetachedListener , IShowSkipListener{
    ...
    private boolean isShowCaseViewSkipped = false;

    private OnSequenceItemShownListener mOnItemShownListener = null;
    private OnSequenceSkipListener mOnShowSkippedListener = null;
    ...
    public void setOnShowSkippedListener(OnSequenceSkipListener listener) {
        this.mOnShowSkippedListener = listener;
    }
    ...
    private void showNextItem() {
        ...
        if(!isShowCaseViewSkipped) {
            if (mShowcaseQueue.size() > 0 && !mActivity.isFinishing()) {
                ...
                sequenceItem.setSkipListener(this);
    ...
    public void onShowcaseDetached(MaterialShowcaseView showcaseView, boolean wasDismissed) {
        ...
        showcaseView.setSkipListener(null);
    ...
    @Override
    public void onShowcaseSkipped() {
        isShowCaseViewSkipped = true;
        if (mOnShowSkippedListener != null) {
            mOnShowSkippedListener.onSkip();
        }
    }
