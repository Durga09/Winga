...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private IShowSkipListener mShowSkipListener;
    ...
    private void init(Context context) {
        ...
        View skipView = LayoutInflater.from(getContext()).inflate(R.layout.lay_skip, this, true);


        mSkipButton = (TextView) skipView.findViewById(R.id.tv_skip);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.tv_dismiss){
            ...
            if (mShowSkipListener != null) {
                mShowSkipListener.onShowcaseSkipped();
                hide();
            }
    ...
    private void setSkipText(CharSequence skipText) {
        if (mSkipButton != null) {
            SpannableString content = new SpannableString(skipText);
    ...
    private void setSkipTextToLeft() {
        if (mSkipButton != null) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mSkipButton.getLayoutParams();
    ...
    void setSkipListener(IShowSkipListener skipListener) {
        mShowSkipListener = skipListener;
    }
    ...
    public static class Builder {
        ...
        public Builder setSkipToLeft(){
            showcaseView.setSkipTextToLeft();
            return this;
        }
