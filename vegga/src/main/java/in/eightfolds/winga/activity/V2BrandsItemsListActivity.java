...
public class V2BrandsItemsListActivity extends BaseActivity implements View.OnClickListener, VolleyResultCallBack, OnEventListener {
    ...
    public void onEventListener(int type, Object object) {
        if (object instanceof TopBrands) {
            selectedId=((TopBrands) object).getNumber();
            title=((TopBrands) object).getName();
            getWingaStoreItem();
        }
    ...
    private void setProductsAdapter(ArrayList<StoreItem> storeItems) {
        if (storeItems.size() > 0) {
            ...
            storeItemAdapter = new StoreItemAdapter( storeItems,V2BrandsItemsListActivity.this,this);
    ...
    private void setTopBrandAdapter(ArrayList<TopBrands> topBrands) {
        if(topBrands.size()>0){
            ...
            topBrandsAdapter = new TopBrandsAdapter(topBrands, V2BrandsItemsListActivity.this, this, 1);
