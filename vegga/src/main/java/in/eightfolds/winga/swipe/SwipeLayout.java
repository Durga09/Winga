...
public class SwipeLayout extends ViewGroup {
    ...
    public void setEnablePullToBack(boolean b) {
        enablePullToBack = b;
        Logg.i(TAG, "enablePullToBack:" + enablePullToBack);
    }
    ...
    private void findScrollView(ViewGroup viewGroup) {
        ...
        if (viewGroup.getChildCount() > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (child instanceof AbsListView || child instanceof ScrollView || child instanceof ViewPager || child instanceof WebView || child instanceof LinearLayout) {
                    scrollChild = child;
                    return;
                }
            }
